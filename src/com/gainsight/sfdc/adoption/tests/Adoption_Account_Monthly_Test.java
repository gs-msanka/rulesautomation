...
public class Adoption_Account_Monthly_Test extends BaseTest {
    ...
    @TestInfo(testCaseIds={"GS-499","GS-2762"})
    @Test(dataProviderClass = com.gainsight.utils.ExcelDataProvider.class, dataProvider = "excel")
