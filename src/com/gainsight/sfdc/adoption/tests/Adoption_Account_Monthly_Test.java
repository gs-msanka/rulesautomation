...
public class Adoption_Account_Monthly_Test extends BaseTest {
    ...
    public void usageDataVerification2() {
        ...
        Assert.assertEquals(true, usage.isGridHeaderMapped("Customer | Renewal Date"));
        //Checking the adoption data for a customer instance.
        Assert.assertEquals(true, usage.isDataPresentInGrid("A and T unlimit Limited | 9,306 | 17,213 | 15,523 | 16,138 | 9,694 | 18,201 | 5,007 | 3,168 | 8,451 | 10,274 | 9,432 | 14,191 "));
    }
    ...
    public void usageDataVerificationInGirdAndGraph() {
        ...
        Assert.assertTrue(analyticsPage.isDataPresentInGrid("Files Downloaded | 7,918 | 4,928 | 7,465 | 3,161 | 18,685 | 3,807 | 13,837 | 10,014 | 14,345 | 3,187 | 1,746 | 10,415"), "Checking Files Downloaded measure");
        Assert.assertTrue(analyticsPage.isDataPresentInGrid("No of Report Run | 4,642 | 16,292 | 10,292 | 6,509 | 14,256 | 532 | 6,101 | 6,749 | 286 | 18,785 | 6,703 | 14,140"), "Checking No of Report Run measure");
        Assert.assertTrue(analyticsPage.isDataPresentInGrid("Page Views | 12,642 | 5,382 | 9,071 | 9,657 | 14,532 | 10,825 | 18,729 | 16,560 | 15,006 | 16,651 | 6,096 | 15,236"), "Checking Page Views measure");
        Assert.assertTrue(analyticsPage.isDataPresentInGrid("Page Visits | 3,189 | 11,991 | 8,442 | 11,895 | 16,706 | 7,995 | 6,783 | 365 | 17,703 | 8,039 | 3,281 | 5,798"), "Checking Page Visits measure");
    ...
    public void viewUsageForCustomer() {
        ...
        Assert.assertTrue(usage.isDataPresentInGrid("Files Downloaded | 11,728 | 18,382 | 3,056 | 7,429 | 9,768 | 3,984 | 11,868 | 6,039 | 12,644 | 9,540 | 7,087 | 9,794"), "Checking the adoption grid displayed below the graph(Files Downloaded).");
        Assert.assertTrue(usage.isDataPresentInGrid("No of Report Run | 5,520 | 2,235 | 3,545 | 14,451 | 12,592 | 14,436 | 1,091 | 1,290 | 13,221 | 1,217 | 4,672 | 9,813"), "Checking the adoption grid displayed below the graph(No of Report Run).");
        Assert.assertTrue(usage.isDataPresentInGrid("Page Views | 14,665 | 15,041 | 2,640 | 16,799 | 8,223 | 3,415 | 18,570 | 13,598 | 395 | 2,193 | 7,445 | 9,421"), "Checking the adoption grid displayed below the graph(Page Views).");
        Assert.assertTrue(usage.isDataPresentInGrid("Page Visits | 9,219 | 12,487 | 3,520 | 729 | 8,756 | 11,505 | 18,441 | 6,710 | 853 | 14,468 | 13,664 | 915"), "Checking the adoption grid displayed below the graph(Page Visits).");
    }
    ...
    public void viewPartialUsageForCustomer() {
        ...
        Assert.assertTrue(usage.isDataPresentInGrid("Files Downloaded | 8,040 | 8,369 | 8,432 | 17,941 | 11,288 | 650 | 8,007 | 1,013 | 14,158 | 14,852 | 8,515"), "Checking the adoption grid displayed below the graph(Files Downloaded).");
        Assert.assertTrue(usage.isDataPresentInGrid("No of Report Run | 6,323 | 4,666 | 2,076 | 13,933 | 99 | 10,374 | 2,529 | 5,032 | 4,104 | 10,819 | 11,004"), "Checking the adoption grid displayed below the graph(No of Report Run).");
        Assert.assertTrue(usage.isDataPresentInGrid("Page Views | 10,544 | 10,834 | 7,322 | 1,898 | 4,179 | 1,736 | 17,472 | 9,019 | 10,077 | 14,860 | 2,914"), "Checking the adoption grid displayed below the graph(Page Views).");
        Assert.assertTrue(usage.isDataPresentInGrid("Page Visits | 4,461 | 2,593 | 490 | 2,277 | 9,651 | 13,360 | 3,260 | 9,567 | 17,603 | 13,388 | 18,052"), "Checking the adoption grid displayed below the graph(Page Visits).");
    }
