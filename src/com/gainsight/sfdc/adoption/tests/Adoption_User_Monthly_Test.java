...
public class Adoption_User_Monthly_Test extends BaseTest {
    ...
    public void usageDataVerificationSum() {
        ...
        Assert.assertEquals(true, usage.isDataPresentInGrid("AGENCE PRESSE | 30,365 | 31,016 | 29,953 | 26,452 | 33,155 | 44,518 | 37,036 | 38,272 | 30,545 | 26,845 | 41,687 | 33,144"));
    }
    ...
    public void usageDataVerificationAvg() {
        ...
        Assert.assertEquals(true, usage.isGridHeaderMapped("Customer | Renewal Date"));
        //Checking the adoption data for a customer instance.
        Assert.assertEquals(true, usage.isDataPresentInGrid("TOMAS MARTINEZ PATLAN | 2,064.7 | 2,889 | 2,291.6 | 2,470 | 3,948.6 | 2,944 | 2,853.2 | 2,787.4 | 2,565.4 | 3,055.1 | 3,465.8 | 3,091.5"));
    }
    ...
    public void usageDataVerificationCount() {
        ...
        Assert.assertEquals(true, usage.isGridHeaderMapped("Customer | Renewal Date"));
        //Checking the adoption data for a customer instance.
        Assert.assertEquals(true, usage.isDataPresentInGrid("PRODUCCIONES AGRICOLA DE TABASCO SA CV | 10 | 10 | 10 | 10 | 10 | 10 | 10 | 10 | 10 | 10 | 10 | 10"));
    }
    ...
    public void usageDataVerificationInGirdAndGraph() {
        ...
        Assert.assertEquals(true, usage.isGridHeaderMapped("Customer | Renewal Date"));
        //Checking the adoption data for a customer instance.
        Assert.assertEquals(true, usage.isDataPresentInGrid("PROD Y DIS VER FRESCAS GUIJOSA SC RL CV | 30,167 | 28,855 | 28,510 | 34,614 | 29,865 | 33,386 | 24,705 | 20,189 | 31,537 | 29,690"));
        ...
        Assert.assertTrue(analyticsPage.isDataPresentInGrid("Files Downloaded | 26,332 | 33,098 | 30,167 | 28,855 | 28,510 | 34,614 | 29,865 | 33,386 | 24,705 | 20,189 | 31,537 | 29,690"), "Checking Files Downloaded measure");
        Assert.assertTrue(analyticsPage.isDataPresentInGrid("No of Report Run | 2,051.3 | 3,481.8 | 3,268.9 | 3,184.4 | 3,443.5 | 2,339.2 | 4,108.9 | 2,651.1 | 3,490.1 | 2,902.8 | 3,518.7 | 3,780.7"), "Checking No of Report Run measure");
        Assert.assertTrue(analyticsPage.isDataPresentInGrid("Page Views | 10 | 10 | 10 | 10 | 10 | 10 | 10 | 10 | 10 | 10 | 10 | 10"), "Checking Page Views measure");
        Assert.assertTrue(analyticsPage.isDataPresentInGrid("Page Visits | 26,340 | 31,398 | 26,094 | 32,895 | 33,841 | 36,179 | 24,606 | 21,731 | 27,974 | 21,303 | 17,996 | 24,286"), "Checking Page Visits measure");
    ...
    public void viewUsageForCustomer() {
        ...
        Assert.assertTrue(usage.isDataPresentInGrid("Files Downloaded | 31,599 | 26,669 | 32,966 | 22,179 | 26,908 | 32,334"), "Checking the adoption grid displayed below the graph(Files Downloaded).");
        Assert.assertTrue(usage.isDataPresentInGrid("No of Report Run | 3,493.6 | 3,994.6 | 2,849.5 | 3,625 | 3,720.7 | 4,040.8"), "Checking the adoption grid displayed below the graph(No of Report Run).");
        Assert.assertTrue(usage.isDataPresentInGrid("Page Views | 10 | 10 | 10 | 10 | 10 | 10"), "Checking the adoption grid displayed below the graph(Page Views).");
        Assert.assertTrue(usage.isDataPresentInGrid("Page Visits | 34,107 | 24,561 | 27,229 | 26,234 | 33,826 | 23,799\n"), "Checking the adoption grid displayed below the graph(Page Visits).");
    }
    ...
    public void viewPartialUsageForCustomer() {
        ...
        Assert.assertTrue(usage.isChartDisplayed(), "Verifying the adoption chart is displayed for the user.");
        Assert.assertTrue(usage.isGridDispalyed(), "Checking the adoption grid is displayed.");
        Assert.assertTrue(usage.isMissingDataInfoDisplayed(), "Checking the missing data info message is displayed");
        Assert.assertTrue(usage.isDataPresentInGrid("Files Downloaded | 33,878 | 41,300 | 32,545 | 31,705 | 28,718 | 33,373 | 20,211 | 27,773 | 29,329 | 32,262 | 34,078 | 34,355 | 34,115 | 25,939 | 24,249 | 22,101 | 27,047 | "), "Checking the adoption grid displayed below the graph(Files Downloaded).");
        Assert.assertTrue(usage.isDataPresentInGrid("No of Report Run | 4,116.1 | 3,153.8 | 2,245.2 | 2,375.2 | 3,686.1 | 3,437.1 | 3,125.3 | 3,079.2 | 3,179.2 | 2,149.3 | 3,377.9 | 3,141 | 3,167.7 | 3,185.6 | 2,966.6 | 3,225.7 | 1,922.2"), "Checking the adoption grid displayed below the graph(No of Report Run).");
        Assert.assertTrue(usage.isDataPresentInGrid("Page Views | 10 | 10 | 10 | 10 | 10 | 10 | 10 | 10 | 10 | 10 | 10 | 10 | 10 | 10 | 10 | 10 | 10"), "Checking the adoption grid displayed below the graph(Page Views).");
        Assert.assertTrue(usage.isDataPresentInGrid("Page Visits | 32,650 | 33,648 | 28,934 | 28,970 | 37,752 | 35,012 | 26,814 | 41,918 | 33,119 | 24,256 | 42,444 | 32,677 | 26,606 | 29,274 | 36,111 | 28,615 | 23,643"), "Checking the adoption grid displayed below the graph(Page Visits).");
    }
