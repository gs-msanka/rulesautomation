...
class BaseXPathConstants {
    ...
    static {
        ...
        XPATHCONSTANTS.put("SEARCHDATASOURCE", "//div[@class='ui-multiselect-filter']/input[@placeholder='Search' and @type='text']");
        XPATHCONSTANTS.put("ADDSHOWME", "//div[@class='gs-rb-show-content clearfix']/div[@class='gs-rb-filterAdd-icon']");
        ...
        XPATHCONSTANTS.put("SEARCHSHOWMEFieldMDA", "//div[@class='customTreeContainer']/div/input[@placeholder='Search...']");
        XPATHCONSTANTS.put("WAITTOLOADFILEDSFOROBJECT", "//div[@class='customTreeContainer']/div/input[@placeholder='Search...']");
      //span[contains(text(),'Loading fields')]
        ...
        XPATHCONSTANTS.put("REPOSITORY_SEARCH_TXT_XPATH", "//input[@type='text' and @class='layout_search_input gs-rb-search form-control']");
        XPATHCONSTANTS.put("CLICK_SEARCHREPORTNAME_REPOSITORY", "//li[@class='layout_list ui-report-compo' and @title='%s']");
        ...
        XPATHCONSTANTS.put("DELETE_YES_BTN_XPATH", "//input[@type='button' and @value = 'Yes' and contains(@class,'btn-save')]");
        ...
        XPATHCONSTANTS.put("CLICKSEARCHEDOBJECTNAME", "//li/label/input[@title='%s']/following-sibling::span[contains(text(),'%s')]");
        XPATHCONSTANTS.put("VERIFYSELECTEDOBJECTNAME", "//span[@class='ui-multiselect-selected-label' and text()='%s']");

        XPATHCONSTANTS.put("CLICKSEARCHSHOWMEFIELd", "//div[@data-areatype='SELECT']//li[@title='%s' and contains(@data-parent,'%s')]");
        XPATHCONSTANTS.put("CLICKSEARCHSHOWMEFIELdMDA", "//div[@class='customTreeContainer']//a/span[text()='%s']");
        XPATHCONSTANTS.put("CLICKSEARCHBYFIELD", "//div[@data-areatype='BY']//li[@title='%s' and contains(@data-parent,'%s')]");
