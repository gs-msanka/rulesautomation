...
public class SurveyDistributionListTest extends SurveySetup {
	...
	public void setUp() throws Exception {
		...
		sfdc.runApexCode(resolveStrNameSpace("List<JBCXM__SurveyDistributionSchedule__c> distribution = [SELECT Id, JBCXM__Status__c FROM JBCXM__SurveyDistributionSchedule__c];for(JBCXM__SurveyDistributionSchedule__c acct :distribution){acct.JBCXM__Status__c = 'Aborted';}update distribution;"));
	}
