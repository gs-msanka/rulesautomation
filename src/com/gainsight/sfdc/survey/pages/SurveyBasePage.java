...
public class SurveyBasePage extends BasePage {
    ...
    private final String DRAFTS_SECTION             = "//a[@ref-module='DASHBOARD']";
    private final String PUBLISHED_SECTION          = "//a[@ref-module='DASHBOARD']";
    private final String EXPIRED_SECTION            = "//a[@ref-module='DASHBOARD']";
