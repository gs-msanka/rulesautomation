...
public class ObjectFields {
    ...
    private List<String>  autoNumber = new ArrayList<String>();
    ...
    private List<HashMap<String,String[]>> pickLists = new ArrayList<HashMap<String,String[]>>();
    private List<HashMap<String,String[]>> multiPickLists = new ArrayList<HashMap<String,String[]>>();
    private List<String>  textAreas = new ArrayList<String>();
    private List<String>  encryptedStrings = new ArrayList<String>();
    private List<String>  URLs = new ArrayList<String>();
    private List<HashMap<String, String>> lookups= new ArrayList<HashMap<String, String>>();
    private List<String>  Dates = new ArrayList<String>();
    private List<String>  dateTimes = new ArrayList<String>();
    private List<String>  geoLocation = new ArrayList<String>();
    private List<String>  textArea_Long = new ArrayList<String>();
    private List<String>  textArea_Rich = new ArrayList<String>();
    private List<HashMap<String, String>> FormulaFieldsList= new ArrayList<HashMap<String, String>>();
    private List<String>  externalID_Text = new ArrayList<String>();
    private List<String>  externalID_TextArea = new ArrayList<String>();
    private List<String>  externalID_TextAreaRich = new ArrayList<String>();
