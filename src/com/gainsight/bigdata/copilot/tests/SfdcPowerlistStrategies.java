...
public class SfdcPowerlistStrategies extends CopilotTestUtils{
    ...
    public void testPreviewEmail() throws Exception {
        ...
        String actualEmailTemplateData = copilotAPI.previewOutReachAndGetData(actualOutReach.getCampaignId(), payload);
        ...
        Log.debug("Sample/Test Run Email Payload is ==========>   " + sampleEmailPayload);
