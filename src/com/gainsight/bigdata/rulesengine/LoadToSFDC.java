...
public class LoadToSFDC extends RulesUtil {
    ...
    public void beforeClass() throws Exception {
        ...
        if(testDataList.size()>0) {
            ...
            throw new RuntimeException("Exception occurred while load data to customers. Please load data again");
        }
        ...
        metaUtil.addFieldPermissionsToUsers("CustomSourceWeRules__c", metaUtil.convertFieldNameToAPIName(customFields), sfinfo);
        ...
        metaUtil.addFieldPermissionsToUsers("CustomWeRules__c",  metaUtil.convertFieldNameToAPIName(customFields), sfinfo);
    ...
    public void insertOperation(HashMap<String, String> testData) throws Exception {
        ...
        Assert.assertTrue(createAndRunRule(testData),
"Rule Created and Ran Successfully!");
