...
public class CreateCTA extends RulesUtil{
	...
	public void Rule1(HashMap<String,String> testData) throws Exception {
            ...
            String LRR = getSFId("SFID:JBCXM__LastRunResult__c:JBCXM__AutomatedAlertRules__c:Name"+ruleId+"");
            ...
            Assert.assertTrue(ru.isCTACreateSuccessfully(cta.getPriority(), cta.getStatus(), cta.getCustomer(), cta.getType(), cta.getReason(), cta.getComments(), RuleName,null,false));
        }   
	...
	public void Rule2(HashMap<String,String> testData) throws Exception {
        ...
        //Verify if CTA created has Priority as HIGH, Status as Open, Assigned as same value of Account createdby,Type as Risk, Reason as Product Performance
        CTA cta=mapper.readValue(testData.get("CTACriteria"), CTA.class);
        Assert.assertTrue(ru.isCTACreateSuccessfully(cta.getPriority(), cta.getStatus(), cta.getCustomer(), cta.getType(), cta.getReason(), cta.getComments(), RuleName,cta.getPlaybookName(),false));
       }
	...
	public void Rule3(HashMap<String,String> testData) throws Exception {
		...
		metadataClient.createLookupField("Account", new String[]{"C_Reference"}, new String[]{"User","Acco2untS_AutomationS"});
       ...
       result = wa.doPost(PropertyReader.nsAppUrl + "/api/eventrule/" +ruleId, header.getAllHeaders(),"{}");
        ...
        //Verify if CTA created has Priority as HIGH, Status as Open, Assigned as same value of Account createdby,Type as Risk, Reason as Product Performance
        CTA cta=mapper.readValue(testData.get("CTACriteria"), CTA.class);
        Assert.assertTrue(ru.isCTACreateSuccessfully(cta.getPriority(), cta.getStatus(), cta.getCustomer(), cta.getType(), cta.getReason(), cta.getComments(), RuleName,cta.getPlaybookName(),true));
	...
	public void Rule4(HashMap<String,String> testData) throws Exception {
       ...
       result = wa.doPost(PropertyReader.nsAppUrl + "/api/eventrule/" +ruleId, header.getAllHeaders(),"{}");
        ...
        fieldsAndValues.put("Id", "");	fieldsAndValues.put("Name", ""); fieldsAndValues.put("Type", "");	fieldsAndValues.put("Fax", "");
        fieldsAndValues.put("Website", "");	fieldsAndValues.put("AnnualRevenue", ""); fieldsAndValues.put("NumberOfEmployees", "");	fieldsAndValues.put("Description", "");
        fieldsAndValues.put("OwnerId", "");	
        
         getSFValues(fieldsAndValues,"Account:Name:"+RuleName);
       	String OwnerName=getSFId("SFID:Name:User:Id:"+fieldsAndValues.get("OwnerId"));
       										//This CTA is assigned to AccountID ${Id} Account Name:${Name}  ${Description} ${Fax} ${Type} ${AnnualRevenue} ${NumberOfEmployees} ${LastActivityDate} ${Website} ${OwnerId}  ${Owner.Name}
            String Comment="This CTA is assigned to AccountID "+fieldsAndValues.get("Id")+" Account Name:"+fieldsAndValues.get("Name") +" "+ fieldsAndValues.get("Description") +" "+ fieldsAndValues.get("Fax") +" "+ fieldsAndValues.get("Type") +" "+ fieldsAndValues.get("AnnualRevenue") +" "+fieldsAndValues.get("NumberOfEmployees")+" NA"
           +" "+fieldsAndValues.get("Website") +" "+ fieldsAndValues.get("OwnerId") +" "+ OwnerName;
	...
	public void Rule5(HashMap<String,String> testData) throws Exception {
		...
		String FieldsToDelete[]={"C_Text","C_Number","C_Checkbox","C_Currency","C_Email","C_Percent","C_Phone","C_Picklist","C_MultiPicklist","C_TextArea"};
		String FieldsToDelete1[]={"C_EncryptedString","C_URL","C_Reference"};		
        ...
        for (SObject r : CTAreq) {
            ...
            fAndV.put("Id",""); fAndV.put("C_Text__c",""); fAndV.put("C_Number__c",""); fAndV.put("C_Checkbox__c",""); fAndV.put("C_Currency__c",""); fAndV.put("C_Email__c",""); fAndV.put("C_Percent__c",""); 
            fAndV.put("C_Phone__c",""); fAndV.put("C_Picklist__c",""); fAndV.put("C_MultiPicklist__c","");fAndV.put("C_TextArea__c",""); fAndV.put("C_EncryptedString__c",""); fAndV.put("C_URL__c",""); fAndV.put("C_Reference__c","");
            fAndV=getSFValues(fAndV, "Account:Name:"+RuleName);
            //This CTA is assigned to AccountID ${Id} ${C_Checkbox__c} ${C_Currency__c} ${C_Email__c} ${C_EncryptedString__c} ${C_MultiPicklist__c} ${C_Number__c} ${C_Percent__c} ${C_Phone__c} ${C_Picklist__c} ${C_Reference__c} ${C_Text__c} ${C_TextArea__c} ${C_URL__c}
            String Comment="This CTA is assigned to AccountID "+fAndV.get("Id")+" "+fAndV.get("C_Checkbox__c")+" "+fAndV.get("C_Currency__c")+" "+
            							fAndV.get("C_Email__c")+" "+fAndV.get("C_EncryptedString__c")+" "+fAndV.get("C_MultiPicklist__c")+" "+
            							fAndV.get("C_Number__c")+" "+fAndV.get("C_Percent__c")+" "+fAndV.get("C_Phone__c")+" "+fAndV.get("C_Picklist__c")+" "+
            							fAndV.get("C_Reference__c")+" "+fAndV.get("C_Text__c")+" "+fAndV.get("C_TextArea__c")+" "+fAndV.get("C_URL__c");
            //Comment=Comment.replaceAll(" ", "");
          //Verify if CTA created has Priority as HIGH, Status as Open, Assigned as same value of Account createdby,Type as Risk, Reason as Product Performance
            CTA cta=mapper.readValue(testData.get("CTACriteria"), CTA.class);
            cta.setComments(Comment);
