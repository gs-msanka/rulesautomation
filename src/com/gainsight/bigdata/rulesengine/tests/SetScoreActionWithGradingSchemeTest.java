...
public class SetScoreActionWithGradingSchemeTest extends BaseTest {
	...
	public void setScoreWithGradingSchemeEnabled() throws Exception{
		...
		List<Map<String, String>> expectedData = Comparator.getParsedCsvData(new CSVReader(FileUtil.resolveNameSpace(new File(Application.basedir + "/testdata/newstack/RulesEngine/RulesUI-TestData/GS-3385/GS-3825-ExpectedDataForGradingScheme.csv"), NAMESPACE)));
	...
	public void setScoreWithStaticvalueWithGradingScheme() throws Exception{
		...
		List<Map<String, String>> expectedData = Comparator.getParsedCsvData(new CSVReader(FileUtil.resolveNameSpace(new File(Application.basedir + "/testdata/newstack/RulesEngine/RulesUI-TestData/GS-3825/GS3825-ExpectedDataForGradingSchema.csv"), NAMESPACE)));
	...
	public void setScoreUsingAggregatedFieldWithGradingScheme() throws Exception{
		...
		List<Map<String, String>> expectedData = Comparator.getParsedCsvData(new CSVReader(FileUtil.resolveNameSpace(new File(Application.basedir + "/testdata/newstack/RulesEngine/RulesUI-TestData/GS-3837/GS-3837-ExpectedDataForGradingSchema.csv"), NAMESPACE)));
