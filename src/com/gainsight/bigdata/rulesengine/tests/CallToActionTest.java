    ...
    public void testCloseCtaFromSpecificSource() throws Exception {
        ...
        if (closeCtaPojo.getSetupActions().get(0).getActionType().name().contains("CloseCTA")) {
            ...
            for (SObject tokenRecords : ctarecords) {
                ...
                String actualTokenComments = (String) tokenRecords.getChild(resolveStrNameSpace("JBCXM__Account__r")).getChild("C_Picklist__c").getValue() + tokenRecords.getChild(resolveStrNameSpace("JBCXM__Account__r")).getChild("Percent_Auto__c").getValue() + tokenRecords.getChild(resolveStrNameSpace("JBCXM__Account__r")).getChild("Id").getValue() + tokenRecords.getChild((resolveStrNameSpace("JBCXM__Account__r"))).getChild("Name").getValue();
