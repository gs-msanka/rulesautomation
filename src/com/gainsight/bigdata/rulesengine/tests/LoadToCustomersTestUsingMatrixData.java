...
/**
 * Created by msanka on 3/14/2016.
 */
 ...
 */
public class LoadToCustomersTestUsingMatrixData extends BaseTest {
    ...
    public void testLoadToCustomers() throws Exception {
        ...
        List<Map<String, String>> expectedData = Comparator.getParsedCsvDataWithHeaderNamespaceResolved(TEST_DATA_DIR + "GS-3149/GS-3149-Matrix-ExpectedData.csv");
    ...
    public void testLoadToCustomers2() throws Exception {
        ...
        dataETL.execute(jobInfo);
        List<Map<String, String>> expectedData = Comparator.getParsedCsvDataWithHeaderNamespaceResolved(TEST_DATA_DIR + "GS-5135/GS-5135-Matrix-ExpectedData.csv");
